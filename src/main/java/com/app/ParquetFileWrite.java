...
public class ParquetFileWrite {
    ...
    private static Schema parseSchema() {
        ...
        try {
            // pass path to schema
            //schema = parser.parse(ClassLoader.getSystemResourceAsStream("src/main/resources/EmpSchema.avsc"));
            //schema = parser.parse(new File("src/main/resources/EmpSchema.avsc"));
            schema = parser.parse(new File("src/main/resources/sample.avsc"));
    ...
    private static void writeToParquet(List<GenericData.Record> recordList, Schema schema) {
        ...
        Path path = new Path("src/main/resources/s2.parquet");
